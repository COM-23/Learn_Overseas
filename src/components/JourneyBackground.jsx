...
const IMAGES = [
  'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&w=3840&q=100', // Oxford/Grand campus
  'https://images.unsplash.com/photo-1607237138185-eedd9c632b0b?auto=format&fit=crop&w=3840&q=100', // Classic Oxford spire
  'https://images.unsplash.com/photo-1541829070764-84a7d30dd3f3?auto=format&fit=crop&w=3840&q=100', // MIT dome / classic architecture
  'https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=3840&q=100', // Students walking / campus life
  'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=3840&q=100', // Graduation caps
];
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
      <div style={{ position: 'sticky', top: 0, width: '100%', height: '100vh', overflow: 'hidden', background: '#020205' }}>
        ...
        {/* ── Smooth crossfade slideshow to prevent blank screen ── */}
        <AnimatePresence>
          <motion.div
            key={currentIdx}
            initial={{ opacity: 0 }}
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 1010, pointerEvents: 'none', contain: 'layout style' }}>
          {[
            ...
            { label: 'NUS',          col: '#F9D440', x: '78%', delay: 2,    dur: 21 },
            ...
            { label: 'Toronto',      col: '#F9D440', x: '75%', delay: 5,    dur: 29 },
            ...
            { label: 'Caltech',      col: '#7DC1B1', x: '79%', delay: 2,    dur: 24 },
